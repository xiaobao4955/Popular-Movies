...
package com.burhan.udacity.popularmovies.ui.fragment;
...
import com.burhan.udacity.popularmovies.data.model.Review;
...
import com.burhan.udacity.popularmovies.ui.activity.MovieDetailsActivity;
import com.burhan.udacity.popularmovies.ui.helper.MoviesHelper;
import com.burhan.udacity.popularmovies.ui.module.MoviesModule;
import com.burhan.udacity.popularmovies.utils.Lists;
import com.burhan.udacity.popularmovies.utils.UiUtils;
...
public final class MovieFragment extends BaseFragment implements ObservableScrollViewCallbacks {
    ...
    private void onReviewsLoaded(List<Review> reviews) {
        ...
        boolean finalHasReviews = hasReviews;
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mReviewsGroup.setVisibility(finalHasReviews ? View.VISIBLE : View.GONE);
            }
        });
